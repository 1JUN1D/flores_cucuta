...
const CATALOGO = [
    ...
    { num: 41, nombre: "10 Razones para Amarte", descripcion: "Caja corazón negra con 4 rosas rojas, flor nube, 9 Ferrero Rocher y los mensajes de la canción en su interior. Cada razón viene con una flor y un dulce.", precio: 130000, imagen: "../assets/flores_cucuta_41.webp", seccion: "amor", tags: ["rosas", "chocolates", "cajas"], kw: "caja corazon ferrero cancion mensajes" },
    ...
    { num: 63, nombre: "Rosas y Claveles", descripcion: "Ramo de 24 rosas rojas con claveles rosados y eucalipto, envuelto en papel rosa con borde plateado y tarjeta para tu mensaje. Romántico, abundante y lleno de contraste.", precio: 170000, imagen: "../assets/flores_cucuta_63.webp", seccion: "amor", tags: ["rosas"], kw: "24 rosas rojas claveles rosados eucalipto papel rosa" },
    { num: 64, nombre: "Dulce Despertar", descripcion: "Una deliciosa bandeja que combina lo dulce y lo salado: suaves wafles con frutas frescas, sándwich de jamón, queso y lechuga, jugo natural de naranja y chocolisto cremoso. Acompañan copa de yogur griego con frutas y granola, mix de uvas, brownie, jamón, queso y un Ferrero Rocher.", precio: 147000, imagen: "../assets/flores_cucuta_64.webp", seccion: "amor", tags: ["desayunos", "chocolates"], kw: "desayuno bandeja wafles sandwich jugo chocolisto yogur brownie ferrero globos" },
    { num: 65, nombre: "Romance en Bandeja", descripcion: "Bandeja premium con ensalada de frutas con crema de leche, wraps de pollo, jamón, queso y lechuga, mini arepas con queso o salchicha, bebida a elección (café o chocolisto), soda Hatsu y postre casero. Incluye hermoso jarrón de rosas rojas y globo personalizado.", precio: 265000, imagen: "../assets/flores_cucuta_65.webp", seccion: "amor", tags: ["desayunos", "rosas"], kw: "desayuno bandeja premium wraps arepas hatsu postre jarron rosas globo personalizado" },
    { num: 66, nombre: "Experiencia Dulce", descripcion: "Bandeja deliciosa y equilibrada con suaves wafles cubiertos de frutas frescas, wraps de pollo, jamón, queso y lechuga, copa de yogur griego con frutas y granola, brownie con frutos secos, jugo natural de naranja y chocolisto cremoso.", precio: 180000, imagen: "../assets/flores_cucuta_66.webp", seccion: "amor", tags: ["desayunos", "chocolates"], kw: "desayuno bandeja wafles wraps yogur griego granola brownie jugo chocolisto" },
    ...
    { num: 61, nombre: "Corazón Dorado", descripcion: "Caja corazón con rosas eternas amarillas, mariposa dorada y 9 Ferrero Rocher, con lazo amarillo. Un detalle que dura y endulza.", precio: 103000, imagen: "../assets/flores_cucuta_61.webp", seccion: "amarillas", tags: ["eternas", "chocolates", "cajas"], kw: "caja corazon rosas eternas amarillas 9 ferrero" },
    { num: 62, nombre: "Girasoles Rosé", descripcion: "Ramo de 3 girasoles con claveles rosados, rosas durazno, flor nube y eucalipto, envuelto en papel rosa con lazo. Alegría y ternura en un solo detalle.", precio: 90000, imagen: "../assets/flores_cucuta_62.webp", seccion: "amarillas", tags: ["girasoles"], kw: "3 girasoles claveles rosados rosas durazno eucalipto papel rosa economico" },
    // ─── MÁS ARREGLOS ───
